...
declare const ToggleElement_base: (new (...args: any[]) => {
    connectedCallback(): void;
    updatedCallback(_attribute: string, _oldValue: string | null | undefined, _newValue: string | null | undefined): void;
    disconnectedCallback(): void;
    attributeChangedCallback(attribute: string, oldValue: string | null | undefined, newValue: string | null | undefined): void;
    accessKey: string;
...
export declare class ToggleElement extends ToggleElement_base {
    state: "on" | "off";
    private listeners;
