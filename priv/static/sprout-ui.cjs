...
var o = async (t2, e2, n4) => {
  const { placement: r3 = "bottom", strategy: o3 = "absolute", middleware: a3 = [], platform: l3 } = n4, s4 = await (null == l3.isRTL ? void 0 : l3.isRTL(e2));
  let c3 = await l3.getElementRects({ reference: t2, floating: e2, strategy: o3 }), { x: f3, y: u4 } = i(c3, r3, s4), m3 = r3, g3 = {}, d4 = 0;
  for (let n5 = 0; n5 < a3.length; n5++) {
    const { name: p3, fn: h4 } = a3[n5], { x: y3, y: x3, data: w3, reset: v3 } = await h4({ x: f3, y: u4, initialPlacement: r3, placement: m3, strategy: o3, middlewareData: g3, rects: c3, platform: l3, elements: { reference: t2, floating: e2 } });
    f3 = null != y3 ? y3 : f3, u4 = null != x3 ? x3 : u4, g3 = { ...g3, [p3]: { ...g3[p3], ...w3 } }, v3 && d4 <= 50 && (d4++, "object" == typeof v3 && (v3.placement && (m3 = v3.placement), v3.rects && (c3 = true === v3.rects ? await l3.getElementRects({ reference: t2, floating: e2, strategy: o3 }) : v3.rects), { x: f3, y: u4 } = i(c3, m3, s4)), n5 = -1);
  }
...
async function s2(t2, e2) {
  var n4;
  void 0 === e2 && (e2 = {});
  const { x: r3, y: i3, platform: o3, rects: s4, elements: c3, strategy: f3 } = t2, { boundary: u4 = "clippingAncestors", rootBoundary: m3 = "viewport", elementContext: g3 = "floating", altBoundary: d4 = false, padding: p3 = 0 } = e2, h4 = a(p3), y3 = c3[d4 ? "floating" === g3 ? "reference" : "floating" : g3], x3 = l(await o3.getClippingRect({ element: null == (n4 = await (null == o3.isElement ? void 0 : o3.isElement(y3))) || n4 ? y3 : y3.contextElement || await (null == o3.getDocumentElement ? void 0 : o3.getDocumentElement(c3.floating)), boundary: u4, rootBoundary: m3, strategy: f3 })), w3 = l(o3.convertOffsetParentRelativeRectToViewportRelativeRect ? await o3.convertOffsetParentRelativeRectToViewportRelativeRect({ rect: "floating" === g3 ? { ...s4.floating, x: r3, y: i3 } : s4.reference, offsetParent: await (null == o3.getOffsetParent ? void 0 : o3.getOffsetParent(c3.floating)), strategy: f3 }) : s4[g3]);
...
var m = (t2) => ({ name: "arrow", options: t2, async fn(i3) {
  ...
  if (null == o3)
    return {};
  const d4 = a(l3), p3 = { x: s4, y: c3 }, h4 = n2(f3), y3 = e(f3), x3 = r(h4), w3 = await g3.getDimensions(o3), v3 = "y" === h4 ? "top" : "left", b4 = "y" === h4 ? "bottom" : "right", R2 = m3.reference[x3] + m3.reference[h4] - p3[h4] - m3.floating[x3], A2 = p3[h4] - m3.reference[h4], P2 = await (null == g3.getOffsetParent ? void 0 : g3.getOffsetParent(o3));
...
var b2 = function(e2) {
  return void 0 === e2 && (e2 = {}), { name: "flip", options: e2, async fn(n4) {
    var r3;
    const { placement: i3, middlewareData: o3, rects: a3, initialPlacement: l3, platform: c3, elements: f3 } = n4, { mainAxis: u4 = true, crossAxis: m3 = true, fallbackPlacements: g3, fallbackStrategy: h4 = "bestFit", flipAlignment: x3 = true, ...w3 } = e2, v3 = t(i3), b4 = g3 || (v3 === l3 || !x3 ? [d2(l3)] : function(t2) {
      const e3 = d2(t2);
      return [y(t2), e3, y(e3)];
    }(l3)), R2 = [l3, ...b4], A2 = await s2(n4, w3), P2 = [];
...
var T = function(r3) {
  return void 0 === r3 && (r3 = 0), { name: "offset", options: r3, async fn(i3) {
    const { x: o3, y: a3 } = i3, l3 = await async function(r4, i4) {
      const { placement: o4, platform: a4, elements: l4 } = r4, s4 = await (null == a4.isRTL ? void 0 : a4.isRTL(l4.floating)), c3 = t(o4), f3 = e(o4), u4 = "x" === n2(o4), m3 = ["left", "top"].includes(c3) ? -1 : 1, g3 = s4 && u4 ? -1 : 1, d4 = "function" == typeof i4 ? i4(r4) : i4;
      let { mainAxis: p3, crossAxis: h4, alignmentAxis: y3 } = "number" == typeof d4 ? { mainAxis: d4, crossAxis: 0, alignmentAxis: null } : { mainAxis: 0, crossAxis: 0, alignmentAxis: null, ...d4 };
...
var L = function(e2) {
  return void 0 === e2 && (e2 = {}), { name: "shift", options: e2, async fn(r3) {
    const { x: i3, y: o3, placement: a3 } = r3, { mainAxis: l3 = true, crossAxis: c3 = false, limiter: f3 = { fn: (t2) => {
      let { x: e3, y: n4 } = t2;
      return { x: e3, y: n4 };
    } }, ...m3 } = e2, g3 = { x: i3, y: o3 }, d4 = await s2(r3, m3), p3 = n2(t(a3)), h4 = O(p3);
...
var S = { getClippingRect: function(t2) {
  ...
  return { ...e2, x: e2.x - s4.scrollLeft + f3.x, y: e2.y - s4.scrollTop + f3.y };
...
*/
//# sourceMappingURL=sprout-ui.cjs.map
