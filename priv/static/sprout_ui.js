...
var SproutUI = (() => {
  ...
  var o = (t2, e2, n3) => __async(void 0, null, function* () {
    const { placement: r3 = "bottom", strategy: o3 = "absolute", middleware: a2 = [], platform: l4 } = n3, s2 = yield null == l4.isRTL ? void 0 : l4.isRTL(e2);
    let c2 = yield l4.getElementRects({ reference: t2, floating: e2, strategy: o3 }), { x: f3, y: u3 } = i(c2, r3, s2), m3 = r3, g2 = {}, d2 = 0;
    for (let n4 = 0; n4 < a2.length; n4++) {
      const { name: p2, fn: h2 } = a2[n4], { x: y2, y: x3, data: w3, reset: v2 } = yield h2({ x: f3, y: u3, initialPlacement: r3, placement: m3, strategy: o3, middlewareData: g2, rects: c2, platform: l4, elements: { reference: t2, floating: e2 } });
      f3 = null != y2 ? y2 : f3, u3 = null != x3 ? x3 : u3, g2 = __spreadProps(__spreadValues({}, g2), { [p2]: __spreadValues(__spreadValues({}, g2[p2]), w3) }), v2 && d2 <= 50 && (d2++, "object" == typeof v2 && (v2.placement && (m3 = v2.placement), v2.rects && (c2 = true === v2.rects ? yield l4.getElementRects({ reference: t2, floating: e2, strategy: o3 }) : v2.rects), { x: f3, y: u3 } = i(c2, m3, s2)), n4 = -1);
    }
  ...
  var S = { getClippingRect: function(t2) {
    ...
    return __spreadProps(__spreadValues({}, e2), { x: e2.x - s2.scrollLeft + f3.x, y: e2.y - s2.scrollTop + f3.y });
    ...
    return { reference: L(e2, T(n3), o3), floating: __spreadProps(__spreadValues({}, W(n3)), { x: 0, y: 0 }) };
